...
export default function arcoStyleImportPlugin() {
    ...
    libs: [
      {
        ...
        resolveStyle: (name) => {
          ...
          return replaceList.hasOwnProperty(name) ? `@arco-design/web-vue/es/${replaceList[name]}/style/index.js` : `@arco-design/web-vue/es/${name}/style/index.js`
        }
      }
    ]
  })
