  ...
  <Page>
    ...
    <template #top>
      <SearchForm @query="loadData(true)" @reset="resetForm">
        ...
        <div class="search-item">
          <span>发件人</span>
          <a-select v-model="formData.fileName" placeholder="请选择" :allow-search="false">
    ...
    >
      <template #columns>
        <a-table-column title="模版名称" data-index="number" ellipsis tooltip :width="180" />
        <a-table-column title="模板编码" data-index="name" ellipsis tooltip :width="180" />
        <a-table-column title="发送人名称" data-index="type" ellipsis tooltip :width="180" />
        <a-table-column title="状态" data-index="status" ellipsis tooltip :width="180" />
        <a-table-column title="备注" data-index="注释" ellipsis tooltip :width="180" />
        <a-table-column title="账号" data-index="account" ellipsis tooltip :width="180" />
        <a-table-column title="创建时间" data-index="cerateTime" ellipsis tooltip :width="180" />
