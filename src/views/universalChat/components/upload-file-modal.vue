<template>
  <a-modal v-model:visible="visible" title="上传文件" title-align="start" :width="320" :mask-closable="false" @cancel="onClose(true)">
        ...
        <div class="flex flex-col gap-16">
          ...
          >
            <template #upload-button>
              <div class="flex items-center justify-between w-250 px-16 py-8 border-1 border-solid border-#99999933 rounded-6 text-#999999">
                <span>请选择</span>
